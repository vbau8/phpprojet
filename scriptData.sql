...
/* produit */
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('croissant beurre',NULL,1,25,1,NULL);
...
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('pain au chocolat',NULL,1.2,12,1,NULL);
...
/* panier */
insert into panier(montant, refcli) values (100,1);
insert into panier(montant, refcli) values (20,2);
insert into panier(montant, refcli) values (10,3);
/* ligne */
