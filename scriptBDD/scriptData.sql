...
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('carte postale','pop carte',0.5,16,NULL,4);
...
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('carte postale','pop carte',0.5,1,NULL,5);
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('carte postale','pop carte',0.5,6,NULL,6);
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('carte postale','pop carte',0.5,8,NULL,7);
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('carte postale','pop carte',0.5,2,NULL,8);
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('stylo bille','BIC',2.2,40,NULL,3);
insert into produit(libelle, marque, prixUnit, qteStock, pdtPeriss, pdtNonPeriss) values ('stylo bille','BIC',1.1,10,NULL,2);
